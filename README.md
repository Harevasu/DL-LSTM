...
## THEORY
We use a BiLSTM (Bidirectional Long Short-Term Memory) model for NER, which captures contextual information from both directions (past and future). This helps the model better understand the sequence of words and classify each token into categories such as PERSON, LOCATION, ORGANIZATION, etc.


## DESIGN STEPS
### STEP 1: 
Load and preprocess the dataset (e.g., CoNLL 2003 format). Tokenize text and convert words/tags to indices.

### STEP 2:
Create vocabulary and mappings for words and tags.

### STEP 3: 
Define the BiLSTM model architecture using PyTorch.

### STEP 4: 
Train the model using a cross-entropy loss function and optimizer.

### STEP 5:
Evaluate model performance on validation/test set.

### STEP 6: 
Predict named entities on new sample texts.
...
![image](https://github.com/user-attachments/assets/273aa723-a859-4d17-bea3-9fc215b497ef)


### Sample Text Prediction
![image](https://github.com/user-attachments/assets/9ea2fd6b-1cae-44e9-9001-c2988c33db7e)
